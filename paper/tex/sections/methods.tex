...
\authorcomment1{In this section, we describe our pipeline for building a model active region and discuss each of the pieces in detail.}
...
\begin{figure}
    ...
    \caption{Distribution of loop lengths (in Mm) derived from tracing fieldlines through NOAA 1158}
    \label{fig:loops}
\end{figure}
...
\authorcomment1{Should we provide a brief explanation of the forward modeling software here?}
