...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Timelag Maps %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Maps: Timelags and Cross-Correlations}\label{maps}
...
\authorcomment1{Show EM in a few bins for all three heating cases in addition to slopes}


\begin{figure*}
    \plotone{../figures/em_slope_maps.pdf}
    \caption{Maps of EM slopes}
    \label{fig:slope_maps}
\end{figure*}

\begin{figure}
    \plotone{../figures/em_slope_histograms.pdf}
    \caption{Distributions of EM slopes}
    \label{fig:slope_maps}
\end{figure}