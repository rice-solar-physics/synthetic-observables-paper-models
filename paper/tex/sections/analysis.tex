...
\authorcomment1{Should this whole section just go in the results section?}
...
\begin{figure}
    \caption{\authorcomment2{Show example timelag here for a cooling case}}    
\end{figure}
...
\begin{figure}
    \caption{\authorcomment2{Show an example dask DAG here?}}
\end{figure}
