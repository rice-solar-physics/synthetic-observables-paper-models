...
\begin{enumerate}
    ...
    \item The distribution of time lags becomes increasingly broad \deleted{and approaches a uniform distribution} as the heating frequency increases, consistent with the results of \citet{viall_signatures_2016}.
