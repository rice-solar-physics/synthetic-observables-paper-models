...
% Figure showing 1D EM distributions for three different regions and all three heating frequencies
% spell-checker: disable %
\begin{pycode}[manager_results]
sample_points = [
