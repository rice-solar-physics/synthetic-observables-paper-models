...
caption = r'$\sigma_I/\bar{I}$ as defined by Equation 11 of \citep{guarrasi_coronal_2010} computed on a single image at $t=15\times10^3$ s for each channel and heating frequency. A larger value denotes a greater degree of contrast.\label{tab:fuzzy}'
